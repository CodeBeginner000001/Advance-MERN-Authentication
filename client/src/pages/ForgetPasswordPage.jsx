...
const ForgetPasswordPage = () => {
  ...
  return (
    ...
    >
      <div className="p-8">
      <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text">Forget Password</h2>
      {
        !isSubmitted?(
      ...
      <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
        <Link to={"/login"} className="text-green-400 hover:underline flex items-center text-sm">
