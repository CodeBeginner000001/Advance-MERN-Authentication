...
const generateTokenAndSetCookie = (res,userID)=>{
    ...
    res.cookie("token",token,{
        ...
        sameSite: "strict", // secure attacks like CSRF - when an attacker tricks a user into performing unintended actions on a web application by exploiting the trust
